...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 20, textAlign: 'center', borderBottomWidth: 1, borderBottomColor: '#334155', paddingBottom: 10 },
  title: { fontSize: 24, fontWeight: 'bold', color: '#38bdf8' },
  subtitle: { fontSize: 12, color: '#94a3b8', marginTop: 4 },
  masterScoreBox: { backgroundColor: '#1e293b', padding: 15, borderRadius: 8, marginBottom: 20, alignItems: 'center' },
  masterScoreValue: { fontSize: 32, fontWeight: 'bold', color: '#a855f7' },
  masterScoreText: { fontSize: 12, color: '#94a3b8' },
  section: { marginBottom: 12, padding: 10, backgroundColor: '#1e293b', borderRadius: 6 },
  sectionTitle: { fontSize: 13, fontWeight: 'bold', marginBottom: 6, color: '#38bdf8' },
  text: { fontSize: 10, color: '#cbd5e1', marginBottom: 3 },
  footer: { marginTop: 20, textAlign: 'center', fontSize: 9, color: '#64748b' }
});
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <Text style={styles.title}>Resilience Platform Security Report</Text>
      ...
      <Text style={styles.footer}>Generated by DevOps All-In-One Platform • Boardroom Report</Text>
    </Page>
  </Document>
);
